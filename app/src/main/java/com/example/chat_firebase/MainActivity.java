...
public class MainActivity extends AppCompatActivity {
    ...
    private String photo_profile_string;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                databaseReference.push().setValue(new MessageSend(txt_message.getText().toString(),
                        user_name.getText().toString(), "","1", ServerValue.TIMESTAMP));
                txt_message.setText("");
        ...
        photo_profile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.setType("image/jpeg");
                intent.putExtra(Intent.EXTRA_LOCAL_ONLY,true);
                startActivityForResult(Intent.createChooser(intent,"Select a photo"),PHOTO_PROFILE);
            }
        });
        ...
        databaseReference.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                MessageReceive m = snapshot.getValue(MessageReceive.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == PHOTO_SEND && resultCode == RESULT_OK){
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    photo_reference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            Uri downloadUrl = uri;
                            MessageSend m = new MessageSend("Has recibido una imagen",downloadUrl.toString(),user_name.getText().toString(),photo_profile_string,"2",ServerValue.TIMESTAMP);
                            databaseReference.push().setValue(m);
                        }
                    });
                }
            ...
            Uri u = data.getData();
            storageReference = storage.getReference("Images profile");
            final StorageReference photo_reference = storageReference.child(u.getLastPathSegment());
            photo_reference.putFile(u).addOnSuccessListener(this, new OnSuccessListener<UploadTask.TaskSnapshot>() {
                @Override
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    photo_reference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            Uri downloadUrl = uri;
                            photo_profile_string = u.toString();
                            MessageSend m = new MessageSend("Has actualizado tu foto de perfil",downloadUrl.toString(),user_name.getText().toString(),photo_profile_string,"2",ServerValue.TIMESTAMP);
                            databaseReference.push().setValue(m);
                            Glide.with(MainActivity.this).load(u.toString()).into(photo_profile);
                        }
                    });
                }
            });
